    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 82, 0, 2811);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 86, 16, 2897);
    			add_location(h1, file, 86, 0, 2881);
    			add_location(button, file, 88, 0, 2982);
    			add_location(br, file, 90, 0, 3029);
    			...
    			add_location(textarea, file, 91, 0, 3034);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(center, file, 80, 0, 2779);
    		},
